...
export const storageNodes =  {
    ...
    v73115: new StorageType('DdcNodes.StorageNodes', 'Optional', [v73115.AccountId32], v73115.StorageNode) as StorageNodesV73115,
}
...
export interface StorageNodesV73115  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: v73115.AccountId32): Promise<(v73115.StorageNode | undefined)>
    getMany(block: Block, keys: v73115.AccountId32[]): Promise<(v73115.StorageNode | undefined)[]>
    getKeys(block: Block): Promise<v73115.AccountId32[]>
    getKeys(block: Block, key: v73115.AccountId32): Promise<v73115.AccountId32[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<v73115.AccountId32[]>
    getKeysPaged(pageSize: number, block: Block, key: v73115.AccountId32): AsyncIterable<v73115.AccountId32[]>
    getPairs(block: Block): Promise<[k: v73115.AccountId32, v: (v73115.StorageNode | undefined)][]>
    getPairs(block: Block, key: v73115.AccountId32): Promise<[k: v73115.AccountId32, v: (v73115.StorageNode | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v73115.AccountId32, v: (v73115.StorageNode | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v73115.AccountId32): AsyncIterable<[k: v73115.AccountId32, v: (v73115.StorageNode | undefined)][]>
}
