...
export type Type_416 = Type_416_ApplyExtrinsic | Type_416_Finalization | Type_416_Initialization

export interface Type_416_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_416_Finalization {
    __kind: 'Finalization'
}

export interface Type_416_Initialization {
