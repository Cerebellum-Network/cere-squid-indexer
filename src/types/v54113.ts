 ...
 */
export type DdcVerificationEvent = DdcVerificationEvent_ActivityNotInConsensus | DdcVerificationEvent_BatchIndexConversionFailed | DdcVerificationEvent_BeginBillingReportTransactionError | DdcVerificationEvent_BeginChargingCustomersTransactionError | DdcVerificationEvent_BeginRewardingProvidersTransactionError | DdcVerificationEvent_BillingReportCreated | DdcVerificationEvent_BillingReportDoesNotExist | DdcVerificationEvent_CustomerUsageRetrievalError | DdcVerificationEvent_EmptyCustomerActivity | DdcVerificationEvent_EndBillingReportTransactionError | DdcVerificationEvent_EndChargingCustomersTransactionError | DdcVerificationEvent_EndRewardingProvidersTransactionError | DdcVerificationEvent_EraRetrievalError | DdcVerificationEvent_EraValidationNotReady | DdcVerificationEvent_EraValidationReady | DdcVerificationEvent_EraValidationRootsPosted | DdcVerificationEvent_FailedToCreateMerkleProof | DdcVerificationEvent_FailedToCreateMerkleRoot | DdcVerificationEvent_FailedToFetchCurrentValidator | DdcVerificationEvent_FailedToFetchNodeProvider | DdcVerificationEvent_FailedToFetchNodeTotalUsage | DdcVerificationEvent_NoAvailableSigner | DdcVerificationEvent_NodeUsageRetrievalError | DdcVerificationEvent_NotEnoughDACNodes | DdcVerificationEvent_NotEnoughNodesForConsensus | DdcVerificationEvent_PayoutBatchCreated | DdcVerificationEvent_PrepareEraTransactionError | DdcVerificationEvent_SendChargingCustomersBatchTransactionError | DdcVerificationEvent_SendRewardingProvidersBatchTransactionError | DdcVerificationEvent_ValidatorKeySet | DdcVerificationEvent_VerificationKeyStored

/**
 * No activity in consensus.
 */
export interface DdcVerificationEvent_ActivityNotInConsensus {
    __kind: 'ActivityNotInConsensus'
    clusterId: H160
    eraId: number
    id: Bytes
    validator: AccountId32
 ...
 */
export interface DdcVerificationEvent_CustomerUsageRetrievalError {
    __kind: 'CustomerUsageRetrievalError'
    clusterId: H160
    eraId: number
...
export interface DdcVerificationEvent_FailedToFetchCurrentValidator {
    __kind: 'FailedToFetchCurrentValidator'
    validator: AccountId32
}
 ...
 */
export interface DdcVerificationEvent_NotEnoughNodesForConsensus {
    __kind: 'NotEnoughNodesForConsensus'
    clusterId: H160
    eraId: number
    id: Bytes
    validator: AccountId32
 ...
 * The `Event` enum of this pallet
 */
export type DdcClustersEvent = DdcClustersEvent_ClusterActivated | DdcClustersEvent_ClusterBonded | DdcClustersEvent_ClusterCreated | DdcClustersEvent_ClusterEraValidated | DdcClustersEvent_ClusterNodeAdded | DdcClustersEvent_ClusterNodeRemoved | DdcClustersEvent_ClusterNodeValidated | DdcClustersEvent_ClusterParamsSet | DdcClustersEvent_ClusterProtocolParamsSet | DdcClustersEvent_ClusterUnbonded | DdcClustersEvent_ClusterUnbonding
...
export interface DdcClustersEvent_ClusterEraValidated {
    __kind: 'ClusterEraValidated'
    clusterId: H160
    eraId: number
}
...
export type Type_344 = Type_344_ApplyExtrinsic | Type_344_Finalization | Type_344_Initialization

export interface Type_344_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_344_Finalization {
    __kind: 'Finalization'
}

export interface Type_344_Initialization {
...
export const DdcVerificationEvent: sts.Type<DdcVerificationEvent> = sts.closedEnum(() => {
    return  {
        ActivityNotInConsensus: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            id: sts.bytes(),
            validator: AccountId32,
        ...
        CustomerUsageRetrievalError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            nodePubKey: NodePubKey,
            validator: AccountId32,
        ...
        FailedToFetchCurrentValidator: sts.enumStruct({
            validator: AccountId32,
        }),
        ...
        NotEnoughNodesForConsensus: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            id: sts.bytes(),
            validator: AccountId32,
...
export const DdcClustersEvent: sts.Type<DdcClustersEvent> = sts.closedEnum(() => {
    return  {
        ...
        ClusterEraValidated: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
        }),
