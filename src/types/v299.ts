...
export type Event = Event_BagsList | Event_Balances | Event_Bounties | Event_CereDDCModule | Event_ChainBridge | Event_ChildBounties | Event_Contracts | Event_Council | Event_DdcMetricsOffchainWorker | Event_Democracy | Event_ElectionProviderMultiPhase | Event_Elections | Event_Erc20 | Event_Erc721 | Event_Grandpa | Event_Identity | Event_ImOnline | Event_Indices | Event_Multisig | Event_Offences | Event_Proxy | Event_Recovery | Event_Scheduler | Event_Session | Event_Society | Event_Staking | Event_Sudo | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tips | Event_Treasury | Event_Utility | Event_Vesting
 ...
 */
export type ContractsEvent = ContractsEvent_CodeRemoved | ContractsEvent_CodeStored | ContractsEvent_ContractEmitted | ContractsEvent_Instantiated | ContractsEvent_Terminated
