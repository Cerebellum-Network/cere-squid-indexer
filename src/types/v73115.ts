...
export type Type_432 = Type_432_ApplyExtrinsic | Type_432_Finalization | Type_432_Initialization

export interface Type_432_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_432_Finalization {
    __kind: 'Finalization'
}

export interface Type_432_Initialization {
