...
export const BillingFingerprint: sts.Type<BillingFingerprint> = sts.struct(() => {
    return  {
        clusterId: H160,
        eraId: sts.number(),
        startEra: sts.bigint(),
 ...
 */
export type DdcVerificationEvent = DdcVerificationEvent_BatchIndexConversionFailed | DdcVerificationEvent_BeginBillingReportTransactionError | DdcVerificationEvent_BeginChargingCustomersTransactionError | DdcVerificationEvent_BeginRewardingProvidersTransactionError | DdcVerificationEvent_BillingReportCreated | DdcVerificationEvent_BillingReportDoesNotExist | DdcVerificationEvent_BucketAggregateRetrievalError | DdcVerificationEvent_BucketAggregatesRetrievalError | DdcVerificationEvent_ChallengeResponseRetrievalError | DdcVerificationEvent_CommitBillingFingerprintTransactionError | DdcVerificationEvent_EmptyConsistentGroup | DdcVerificationEvent_EmptyCustomerActivity | DdcVerificationEvent_EndBillingReportTransactionError | DdcVerificationEvent_EndChargingCustomersTransactionError | DdcVerificationEvent_EndRewardingProvidersTransactionError | DdcVerificationEvent_EraRetrievalError | DdcVerificationEvent_EraValidationNotReady | DdcVerificationEvent_EraValidationReady | DdcVerificationEvent_EraValidationRootsPosted | DdcVerificationEvent_FailedToCollectVerificationKey | DdcVerificationEvent_FailedToCreateMerkleProof | DdcVerificationEvent_FailedToCreateMerkleRoot | DdcVerificationEvent_FailedToFetchClusterNodes | DdcVerificationEvent_FailedToFetchDacNodes | DdcVerificationEvent_FailedToFetchNodeProvider | DdcVerificationEvent_FailedToFetchNodeTotalUsage | DdcVerificationEvent_FailedToFetchVerificationKey | DdcVerificationEvent_FailedToFetchVerifiedDeltaUsage | DdcVerificationEvent_FailedToFetchVerifiedPayableUsage | DdcVerificationEvent_NoAvailableSigner | DdcVerificationEvent_NodeUsageRetrievalError | DdcVerificationEvent_NotEnoughDACNodes | DdcVerificationEvent_PayoutBatchCreated | DdcVerificationEvent_PrepareEraTransactionError | DdcVerificationEvent_SendChargingCustomersBatchTransactionError | DdcVerificationEvent_SendRewardingProvidersBatchTransactionError | DdcVerificationEvent_TraverseResponseRetrievalError | DdcVerificationEvent_ValidatorKeySet | DdcVerificationEvent_VerificationKeyStored
...
export interface DdcVerificationEvent_BeginBillingReportTransactionError {
    __kind: 'BeginBillingReportTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}
 ...
 */
export interface DdcVerificationEvent_BillingReportCreated {
    __kind: 'BillingReportCreated'
    clusterId: H160
    eraId: number
}

export interface DdcVerificationEvent_BillingReportDoesNotExist {
    __kind: 'BillingReportDoesNotExist'
    clusterId: H160
    eraId: number
    validator: AccountId32
}
...
export interface DdcVerificationEvent_CommitBillingFingerprintTransactionError {
    __kind: 'CommitBillingFingerprintTransactionError'
    clusterId: H160
    eraId: number
    payersRoot: H256
    payeesRoot: H256
...
export interface DdcVerificationEvent_EndBillingReportTransactionError {
    __kind: 'EndBillingReportTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}
...
export type Type_354 = Type_354_ApplyExtrinsic | Type_354_Finalization | Type_354_Initialization

export interface Type_354_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_354_Finalization {
    __kind: 'Finalization'
}

export interface Type_354_Initialization {
...
export const DdcVerificationEvent: sts.Type<DdcVerificationEvent> = sts.closedEnum(() => {
    return  {
        ...
        BeginBillingReportTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        ...
        BillingReportCreated: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
        }),
        BillingReportDoesNotExist: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        ...
        CommitBillingFingerprintTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            payersRoot: H256,
            payeesRoot: H256,
        ...
        EndBillingReportTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
...
export const DdcPayoutsEvent: sts.Type<DdcPayoutsEvent> = sts.closedEnum(() => {
    return  {
        BillingFingerprintCommited: sts.enumStruct({
            validatorId: AccountId32,
            clusterId: H160,
            eraId: sts.number(),
            startEra: sts.bigint(),
