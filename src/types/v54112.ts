...
export interface DdcVerificationEvent_TotalNodeUsageLessThanZero {
    __kind: 'TotalNodeUsageLessThanZero'
    clusterId: H160
    eraId: number
    validator: AccountId32
}
...
export const DdcVerificationEvent: sts.Type<DdcVerificationEvent> = sts.closedEnum(() => {
    return  {
        ...
        TotalNodeUsageLessThanZero: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
