...
export type Type_117 = Type_117_ApplyExtrinsic | Type_117_Finalization | Type_117_Initialization

export interface Type_117_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_117_Finalization {
    __kind: 'Finalization'
}

export interface Type_117_Initialization {
