...
export type Type_332 = Type_332_ApplyExtrinsic | Type_332_Finalization | Type_332_Initialization

export interface Type_332_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_332_Finalization {
    __kind: 'Finalization'
}

export interface Type_332_Initialization {
