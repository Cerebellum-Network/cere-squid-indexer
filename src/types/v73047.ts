...
export const CustomerLedger: sts.Type<CustomerLedger> = sts.struct(() => {
    return  {
        ...
        total: sts.bigint(),
        active: sts.bigint(),
        unlocking: sts.array(() => Type_662),
    }
})

export const Type_662: sts.Type<Type_662> = sts.struct(() => {
    return  {
        value: sts.bigint(),
        block: sts.number(),
    }
...
export type Type_425 = Type_425_ApplyExtrinsic | Type_425_Finalization | Type_425_Initialization

export interface Type_425_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_425_Finalization {
    __kind: 'Finalization'
}

export interface Type_425_Initialization {
