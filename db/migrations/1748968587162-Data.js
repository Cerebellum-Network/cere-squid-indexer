module.exports = class Data1748968587162 {
    ...
    async up(db) {
        ...
        await db.query(`ALTER TABLE "ddc_customer_deposit" RENAME COLUMN "cluster_id" TO "cluster_id_id"`)
        ...
        await db.query(`ALTER TABLE "account" DROP COLUMN "ddc_active_balance"`)
        ...
        await db.query(`ALTER TABLE "ddc_customer_deposit" DROP COLUMN "cluster_id_id"`)
    ...
    async down(db) {
        ...
        await db.query(`ALTER TABLE "ddc_customer_deposit" RENAME COLUMN "cluster_id_id" TO "cluster_id"`)
        await db.query(`DROP TABLE "ddc_customer_balance"`)
        await db.query(`DROP INDEX "public"."IDX_ca9dedb052ca81adfccbc39fbe"`)
        await db.query(`DROP INDEX "public"."IDX_b68a9202651b08715ba6c0c051"`)
        ...
        await db.query(`ALTER TABLE "ddc_customer_charge" DROP COLUMN "cluster_id_id"`)
        await db.query(`ALTER TABLE "ddc_customer_deposit" ADD "cluster_id_id" text`)
        await db.query(`ALTER TABLE "ddc_customer_deposit" DROP COLUMN "cluster_id_id"`)
        await db.query(`DROP INDEX "public"."IDX_e3686189dd530c258c22f53757"`)
        await db.query(`DROP INDEX "public"."IDX_a479afd4b41e2dbe1ed1a81b1f"`)
