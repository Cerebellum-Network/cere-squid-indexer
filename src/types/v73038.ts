...
export type Type_426 = Type_426_ApplyExtrinsic | Type_426_Finalization | Type_426_Initialization

export interface Type_426_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_426_Finalization {
    __kind: 'Finalization'
}

export interface Type_426_Initialization {
