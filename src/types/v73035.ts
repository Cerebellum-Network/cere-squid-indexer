...
export type Type_415 = Type_415_ApplyExtrinsic | Type_415_Finalization | Type_415_Initialization

export interface Type_415_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_415_Finalization {
    __kind: 'Finalization'
}

export interface Type_415_Initialization {
