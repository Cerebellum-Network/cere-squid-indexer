...
export interface PayoutFingerprint {
    ehdId: string
    clusterId: H160
    payersMerkleRoot: H256
    payeesMerkleRoot: H256
    validators: AccountId32[]
}

export type AccountId32 = Bytes

export const PayoutFingerprint: sts.Type<PayoutFingerprint> = sts.struct(() => {
    return  {
        ehdId: sts.string(),
        clusterId: H160,
        payersMerkleRoot: H256,
...
export interface PayoutReceipt {
    ...
    vault: AccountId32
    fingerprint: H256
    totalCollectedCharges: bigint
    totalDistributedRewards: bigint
    totalSettledFees: bigint
...
export type PayoutState = PayoutState_ChargingCustomers | PayoutState_CustomersChargedWithFees | PayoutState_Finalized | PayoutState_Initialized | PayoutState_NotInitialized | PayoutState_ProvidersRewarded | PayoutState_RewardingProviders

export interface PayoutState_ChargingCustomers {
    __kind: 'ChargingCustomers'
}

export interface PayoutState_CustomersChargedWithFees {
    __kind: 'CustomersChargedWithFees'
}

export interface PayoutState_Finalized {
    __kind: 'Finalized'
}

export interface PayoutState_Initialized {
    __kind: 'Initialized'
}

export interface PayoutState_NotInitialized {
    __kind: 'NotInitialized'
}

export interface PayoutState_ProvidersRewarded {
    __kind: 'ProvidersRewarded'
}

export interface PayoutState_RewardingProviders {
    __kind: 'RewardingProviders'
}

export const PayoutReceipt: sts.Type<PayoutReceipt> = sts.struct(() => {
    return  {
        state: PayoutState,
        vault: AccountId32,
        fingerprint: H256,
        totalCollectedCharges: sts.bigint(),
        totalDistributedRewards: sts.bigint(),
        totalSettledFees: sts.bigint(),
...
export const PayoutState: sts.Type<PayoutState> = sts.closedEnum(() => {
    return  {
...
export interface Event_DdcVerification {
    __kind: 'DdcVerification'
    value: DdcVerificationEvent
}
 ...
 */
export type DdcVerificationEvent = DdcVerificationEvent_BatchIndexConversionFailed | DdcVerificationEvent_BeginChargingCustomersTransactionError | DdcVerificationEvent_BeginPayoutTransactionError | DdcVerificationEvent_BeginRewardingProvidersTransactionError | DdcVerificationEvent_BucketAggregateRetrievalError | DdcVerificationEvent_BucketAggregatesRetrievalError | DdcVerificationEvent_ChallengeResponseRetrievalError | DdcVerificationEvent_CommitPayoutFingerprintTransactionError | DdcVerificationEvent_EmptyConsistentGroup | DdcVerificationEvent_EmptyCustomerActivity | DdcVerificationEvent_EndChargingCustomersTransactionError | DdcVerificationEvent_EndPayoutTransactionError | DdcVerificationEvent_EndRewardingProvidersTransactionError | DdcVerificationEvent_EraRetrievalError | DdcVerificationEvent_EraValidationNotReady | DdcVerificationEvent_EraValidationReady | DdcVerificationEvent_EraValidationRootsPosted | DdcVerificationEvent_FailedToCollectVerificationKey | DdcVerificationEvent_FailedToCreateMerkleProof | DdcVerificationEvent_FailedToCreateMerkleRoot | DdcVerificationEvent_FailedToFetchClusterNodes | DdcVerificationEvent_FailedToFetchDacNodes | DdcVerificationEvent_FailedToFetchEHD | DdcVerificationEvent_FailedToFetchInspectionReceipt | DdcVerificationEvent_FailedToFetchNodeChallenge | DdcVerificationEvent_FailedToFetchNodeProvider | DdcVerificationEvent_FailedToFetchNodeTotalUsage | DdcVerificationEvent_FailedToFetchPHD | DdcVerificationEvent_FailedToFetchPaymentEra | DdcVerificationEvent_FailedToFetchTraversedEHD | DdcVerificationEvent_FailedToFetchTraversedPHD | DdcVerificationEvent_FailedToFetchVerificationKey | DdcVerificationEvent_FailedToFetchVerifiedDeltaUsage | DdcVerificationEvent_FailedToFetchVerifiedPayableUsage | DdcVerificationEvent_FailedToSaveInspectionReceipt | DdcVerificationEvent_NoAvailableSigner | DdcVerificationEvent_NodeUsageRetrievalError | DdcVerificationEvent_NotEnoughDACNodes | DdcVerificationEvent_PayoutBatchCreated | DdcVerificationEvent_PayoutReceiptCreated | DdcVerificationEvent_PayoutReceiptDoesNotExist | DdcVerificationEvent_PrepareEraTransactionError | DdcVerificationEvent_SendChargingCustomersBatchTransactionError | DdcVerificationEvent_SendRewardingProvidersBatchTransactionError | DdcVerificationEvent_TraverseResponseRetrievalError | DdcVerificationEvent_ValidatorKeySet | DdcVerificationEvent_VerificationKeyStored

export interface DdcVerificationEvent_BatchIndexConversionFailed {
    __kind: 'BatchIndexConversionFailed'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_BeginChargingCustomersTransactionError {
    __kind: 'BeginChargingCustomersTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_BeginPayoutTransactionError {
    __kind: 'BeginPayoutTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_BeginRewardingProvidersTransactionError {
    __kind: 'BeginRewardingProvidersTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_BucketAggregateRetrievalError {
    __kind: 'BucketAggregateRetrievalError'
    clusterId: H160
    eraId: number
    bucketId: bigint
 ...
 */
export interface DdcVerificationEvent_BucketAggregatesRetrievalError {
    __kind: 'BucketAggregatesRetrievalError'
    clusterId: H160
    eraId: number
    nodePubKey: NodePubKey
    validator: AccountId32
...
export interface DdcVerificationEvent_ChallengeResponseRetrievalError {
    __kind: 'ChallengeResponseRetrievalError'
    clusterId: H160
    eraId: number
...
export interface DdcVerificationEvent_CommitPayoutFingerprintTransactionError {
    __kind: 'CommitPayoutFingerprintTransactionError'
    clusterId: H160
    eraId: number
    payersRoot: H256
    payeesRoot: H256
...
export interface DdcVerificationEvent_EmptyConsistentGroup {
    __kind: 'EmptyConsistentGroup'
}

export interface DdcVerificationEvent_EmptyCustomerActivity {
    __kind: 'EmptyCustomerActivity'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_EndChargingCustomersTransactionError {
    __kind: 'EndChargingCustomersTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_EndPayoutTransactionError {
    __kind: 'EndPayoutTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_EndRewardingProvidersTransactionError {
    __kind: 'EndRewardingProvidersTransactionError'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_EraRetrievalError {
    __kind: 'EraRetrievalError'
    clusterId: H160
    nodePubKey?: (NodePubKey | undefined)
    validator: AccountId32
}

export interface DdcVerificationEvent_EraValidationNotReady {
    __kind: 'EraValidationNotReady'
    clusterId: H160
    eraId: number
}

export interface DdcVerificationEvent_EraValidationReady {
    __kind: 'EraValidationReady'
    clusterId: H160
    eraId: number
}

export interface DdcVerificationEvent_EraValidationRootsPosted {
    __kind: 'EraValidationRootsPosted'
    clusterId: H160
    eraId: number
    validator: AccountId32
    payersMerkleRootHash: H256
    payeesMerkleRootHash: H256
    payersBatchMerkleRootHashes: H256[]
    payeesBatchMerkleRootHashes: H256[]
}

export interface DdcVerificationEvent_FailedToCollectVerificationKey {
    __kind: 'FailedToCollectVerificationKey'
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToCreateMerkleProof {
    __kind: 'FailedToCreateMerkleProof'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToCreateMerkleRoot {
    __kind: 'FailedToCreateMerkleRoot'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchClusterNodes {
    __kind: 'FailedToFetchClusterNodes'
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchDacNodes {
    __kind: 'FailedToFetchDacNodes'
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchEHD {
    __kind: 'FailedToFetchEHD'
}

export interface DdcVerificationEvent_FailedToFetchInspectionReceipt {
    __kind: 'FailedToFetchInspectionReceipt'
}

export interface DdcVerificationEvent_FailedToFetchNodeChallenge {
    __kind: 'FailedToFetchNodeChallenge'
}

export interface DdcVerificationEvent_FailedToFetchNodeProvider {
    __kind: 'FailedToFetchNodeProvider'
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchNodeTotalUsage {
    __kind: 'FailedToFetchNodeTotalUsage'
    clusterId: H160
    nodePubKey: NodePubKey
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchPHD {
    __kind: 'FailedToFetchPHD'
}

export interface DdcVerificationEvent_FailedToFetchPaymentEra {
    __kind: 'FailedToFetchPaymentEra'
}

export interface DdcVerificationEvent_FailedToFetchTraversedEHD {
    __kind: 'FailedToFetchTraversedEHD'
}

export interface DdcVerificationEvent_FailedToFetchTraversedPHD {
    __kind: 'FailedToFetchTraversedPHD'
}

export interface DdcVerificationEvent_FailedToFetchVerificationKey {
    __kind: 'FailedToFetchVerificationKey'
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchVerifiedDeltaUsage {
    __kind: 'FailedToFetchVerifiedDeltaUsage'
}

export interface DdcVerificationEvent_FailedToFetchVerifiedPayableUsage {
    __kind: 'FailedToFetchVerifiedPayableUsage'
}

export interface DdcVerificationEvent_FailedToSaveInspectionReceipt {
    __kind: 'FailedToSaveInspectionReceipt'
}

export interface DdcVerificationEvent_NoAvailableSigner {
    __kind: 'NoAvailableSigner'
    validator: AccountId32
}
 ...
 */
export interface DdcVerificationEvent_NodeUsageRetrievalError {
    __kind: 'NodeUsageRetrievalError'
    clusterId: H160
    eraId: number
    nodePubKey: NodePubKey
    validator: AccountId32
...
export interface DdcVerificationEvent_NotEnoughDACNodes {
    __kind: 'NotEnoughDACNodes'
    numNodes: number
    validator: AccountId32
}
 ...
 */
export interface DdcVerificationEvent_PayoutBatchCreated {
    __kind: 'PayoutBatchCreated'
    clusterId: H160
    eraId: number
}
 ...
 */
export interface DdcVerificationEvent_PayoutReceiptCreated {
    __kind: 'PayoutReceiptCreated'
    clusterId: H160
    eraId: number
}

export interface DdcVerificationEvent_PayoutReceiptDoesNotExist {
    __kind: 'PayoutReceiptDoesNotExist'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_PrepareEraTransactionError {
    __kind: 'PrepareEraTransactionError'
    clusterId: H160
    eraId: number
    payersMerkleRootHash: H256
    payeesMerkleRootHash: H256
...
export interface DdcVerificationEvent_SendChargingCustomersBatchTransactionError {
    __kind: 'SendChargingCustomersBatchTransactionError'
    clusterId: H160
    eraId: number
    batchIndex: number
    validator: AccountId32
...
export interface DdcVerificationEvent_SendRewardingProvidersBatchTransactionError {
    __kind: 'SendRewardingProvidersBatchTransactionError'
    clusterId: H160
    eraId: number
    batchIndex: number
    validator: AccountId32
...
export interface DdcVerificationEvent_TraverseResponseRetrievalError {
    __kind: 'TraverseResponseRetrievalError'
    clusterId: H160
    eraId: number
    aggregateKey: AggregateKey
    aggregator: NodePubKey
...
export interface DdcVerificationEvent_ValidatorKeySet {
    __kind: 'ValidatorKeySet'
    validator: AccountId32
}
 ...
 */
export interface DdcVerificationEvent_VerificationKeyStored {
    __kind: 'VerificationKeyStored'
    verificationKey: Bytes
}

export type AggregateKey = AggregateKey_BucketSubAggregateKey | AggregateKey_NodeAggregateKey

export interface AggregateKey_BucketSubAggregateKey {
    __kind: 'BucketSubAggregateKey'
    value: [bigint, string]
}

export interface AggregateKey_NodeAggregateKey {
    __kind: 'NodeAggregateKey'
    value: string
}
 ...
 * The `Event` enum of this pallet
 */
export type DdcPayoutsEvent = DdcPayoutsEvent_ChargeError | DdcPayoutsEvent_Charged | DdcPayoutsEvent_ChargedPartially | DdcPayoutsEvent_ChargingFinished | DdcPayoutsEvent_ChargingStarted | DdcPayoutsEvent_ClusterReserveFeesCollected | DdcPayoutsEvent_Indebted | DdcPayoutsEvent_NotDistributedOverallReward | DdcPayoutsEvent_NotDistributedReward | DdcPayoutsEvent_PayoutFingerprintCommited | DdcPayoutsEvent_PayoutInitialized | DdcPayoutsEvent_PayoutReceiptFinalized | DdcPayoutsEvent_Rewarded | DdcPayoutsEvent_RewardingFinished | DdcPayoutsEvent_RewardingStarted | DdcPayoutsEvent_TreasuryFeesCollected | DdcPayoutsEvent_ValidatorFeesCollected | DdcPayoutsEvent_ValidatorRewarded
...
export interface DdcPayoutsEvent_ChargedPartially {
    __kind: 'ChargedPartially'
    clusterId: H160
    era: number
    batchIndex: number
    customerId: AccountId32
...
export interface DdcPayoutsEvent_PayoutFingerprintCommited {
    __kind: 'PayoutFingerprintCommited'
...
export interface DdcPayoutsEvent_PayoutInitialized {
    __kind: 'PayoutInitialized'
    clusterId: H160
    era: number
}

export interface DdcPayoutsEvent_PayoutReceiptFinalized {
    __kind: 'PayoutReceiptFinalized'
    clusterId: H160
    era: number
}
 ...
 * The `Event` enum of this pallet
 */
export type DdcNodesEvent = DdcNodesEvent_NodeCreated | DdcNodesEvent_NodeDeleted | DdcNodesEvent_NodeParamsChanged | DdcNodesEvent_NodeTotalUsageUpdated
...
export interface DdcNodesEvent_NodeTotalUsageUpdated {
    __kind: 'NodeTotalUsageUpdated'
    nodePubKey: NodePubKey
 ...
 * The `Event` enum of this pallet
 */
export type DdcClustersEvent = DdcClustersEvent_ClusterActivated | DdcClustersEvent_ClusterBonded | DdcClustersEvent_ClusterCreated | DdcClustersEvent_ClusterEraPaid | DdcClustersEvent_ClusterNodeAdded | DdcClustersEvent_ClusterNodeRemoved | DdcClustersEvent_ClusterNodeValidated | DdcClustersEvent_ClusterParamsSet | DdcClustersEvent_ClusterProtocolParamsSet | DdcClustersEvent_ClusterUnbonded | DdcClustersEvent_ClusterUnbonding
...
export interface DdcClustersEvent_ClusterEraPaid {
    __kind: 'ClusterEraPaid'
    clusterId: H160
    eraId: number
}
...
export interface DdcClustersEvent_ClusterUnbonding {
    __kind: 'ClusterUnbonding'
    clusterId: H160
}
...
export type Type_347 = Type_347_ApplyExtrinsic | Type_347_Finalization | Type_347_Initialization

export interface Type_347_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_347_Finalization {
    __kind: 'Finalization'
}

export interface Type_347_Initialization {
...
export const Event: sts.Type<Event> = sts.closedEnum(() => {
    return  {
        ...
        DdcVerification: DdcVerificationEvent,
 ...
 * `frame_system::Pallet::deposit_event`.
 */
export const DdcVerificationEvent: sts.Type<DdcVerificationEvent> = sts.closedEnum(() => {
    return  {
        BatchIndexConversionFailed: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        BeginChargingCustomersTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        BeginPayoutTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        BeginRewardingProvidersTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        BucketAggregateRetrievalError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            bucketId: sts.bigint(),
            nodePubKey: NodePubKey,
        ...
        BucketAggregatesRetrievalError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            nodePubKey: NodePubKey,
            validator: AccountId32,
        }),
        ChallengeResponseRetrievalError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            aggregateKey: AggregateKey,
            aggregator: NodePubKey,
        ...
        CommitPayoutFingerprintTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            payersRoot: H256,
            payeesRoot: H256,
        ...
        EmptyConsistentGroup: sts.unit(),
        EmptyCustomerActivity: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        EndChargingCustomersTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        EndPayoutTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        EndRewardingProvidersTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        EraRetrievalError: sts.enumStruct({
            clusterId: H160,
            nodePubKey: sts.option(() => NodePubKey),
            validator: AccountId32,
        }),
        EraValidationNotReady: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
        }),
        EraValidationReady: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
        }),
        EraValidationRootsPosted: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
            payersMerkleRootHash: H256,
            payeesMerkleRootHash: H256,
            payersBatchMerkleRootHashes: sts.array(() => H256),
            payeesBatchMerkleRootHashes: sts.array(() => H256),
        }),
        FailedToCollectVerificationKey: sts.enumStruct({
            validator: AccountId32,
        }),
        FailedToCreateMerkleProof: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        FailedToCreateMerkleRoot: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        FailedToFetchClusterNodes: sts.enumStruct({
            validator: AccountId32,
        }),
        FailedToFetchDacNodes: sts.enumStruct({
            validator: AccountId32,
        }),
        FailedToFetchEHD: sts.unit(),
        FailedToFetchInspectionReceipt: sts.unit(),
        FailedToFetchNodeChallenge: sts.unit(),
        FailedToFetchNodeProvider: sts.enumStruct({
            validator: AccountId32,
        }),
        FailedToFetchNodeTotalUsage: sts.enumStruct({
            clusterId: H160,
            nodePubKey: NodePubKey,
            validator: AccountId32,
        }),
        FailedToFetchPHD: sts.unit(),
        FailedToFetchPaymentEra: sts.unit(),
        FailedToFetchTraversedEHD: sts.unit(),
        FailedToFetchTraversedPHD: sts.unit(),
        FailedToFetchVerificationKey: sts.enumStruct({
            validator: AccountId32,
        }),
        FailedToFetchVerifiedDeltaUsage: sts.unit(),
        FailedToFetchVerifiedPayableUsage: sts.unit(),
        FailedToSaveInspectionReceipt: sts.unit(),
        NoAvailableSigner: sts.enumStruct({
            validator: AccountId32,
        }),
        NodeUsageRetrievalError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            nodePubKey: NodePubKey,
            validator: AccountId32,
        }),
        NotEnoughDACNodes: sts.enumStruct({
            numNodes: sts.number(),
            validator: AccountId32,
        }),
        PayoutBatchCreated: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
        }),
        PayoutReceiptCreated: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
        }),
        PayoutReceiptDoesNotExist: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        PrepareEraTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            payersMerkleRootHash: H256,
            payeesMerkleRootHash: H256,
        ...
        SendChargingCustomersBatchTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            batchIndex: sts.number(),
            validator: AccountId32,
        }),
        SendRewardingProvidersBatchTransactionError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            batchIndex: sts.number(),
            validator: AccountId32,
        }),
        TraverseResponseRetrievalError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            aggregateKey: AggregateKey,
            aggregator: NodePubKey,
        ...
        ValidatorKeySet: sts.enumStruct({
            validator: AccountId32,
        }),
        VerificationKeyStored: sts.enumStruct({
            verificationKey: sts.bytes(),
        }),
    }
})

export const AggregateKey: sts.Type<AggregateKey> = sts.closedEnum(() => {
    return  {
        BucketSubAggregateKey: sts.tuple(() => [sts.bigint(), sts.string()]),
        NodeAggregateKey: sts.string(),
    }
})
...
export const DdcPayoutsEvent: sts.Type<DdcPayoutsEvent> = sts.closedEnum(() => {
    return  {
        ...
        ChargedPartially: sts.enumStruct({
            clusterId: H160,
            era: sts.number(),
            batchIndex: sts.number(),
            customerId: AccountId32,
        ...
        PayoutFingerprintCommited: sts.enumStruct({
            validatorId: AccountId32,
            clusterId: H160,
            eraId: sts.number(),
            payersMerkleRoot: H256,
        ...
        PayoutInitialized: sts.enumStruct({
            clusterId: H160,
            era: sts.number(),
        }),
        PayoutReceiptFinalized: sts.enumStruct({
            clusterId: H160,
            era: sts.number(),
        }),
        Rewarded: sts.enumStruct({
...
export const DdcNodesEvent: sts.Type<DdcNodesEvent> = sts.closedEnum(() => {
    return  {
        ...
        NodeTotalUsageUpdated: sts.enumStruct({
            nodePubKey: NodePubKey,
...
export const DdcCustomersEvent: sts.Type<DdcCustomersEvent> = sts.closedEnum(() => {
    return  {
        ...
        BucketTotalCustomersUsageUpdated: sts.enumStruct({
            clusterId: H160,
            bucketId: sts.bigint(),
            transferredBytes: sts.bigint(),
            storedBytes: sts.bigint(),
        ...
        BucketTotalNodesUsageUpdated: sts.enumStruct({
            clusterId: H160,
            bucketId: sts.bigint(),
            transferredBytes: sts.bigint(),
            storedBytes: sts.bigint(),
...
export const DdcClustersEvent: sts.Type<DdcClustersEvent> = sts.closedEnum(() => {
    return  {
        ...
        ClusterUnbonding: sts.enumStruct({
            clusterId: H160,
        }),
    }
})
