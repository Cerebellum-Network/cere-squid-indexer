...
export type InspectionError = InspectionError_AssignmentsError | InspectionError_ClusterError | InspectionError_NoBucketAggregate | InspectionError_NoCollectors | InspectionError_NoGCollectors | InspectionError_Unexpected
