...
export type Type_121 = Type_121_ApplyExtrinsic | Type_121_Finalization | Type_121_Initialization

export interface Type_121_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_121_Finalization {
    __kind: 'Finalization'
}

export interface Type_121_Initialization {
