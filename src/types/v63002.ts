...
export const Type_359: sts.Type<Type_359> = sts.struct(() => {
    return  {
...
export interface ClusterProtocolParams {
...
export const ClusterProtocolParams: sts.Type<ClusterProtocolParams> = sts.struct(() => {
    return  {
        treasuryShare: Perquintill,
        validatorsShare: Perquintill,
        clusterReserveShare: Perquintill,
...
export interface StorageNode {
    ...
    totalUsage?: (NodeUsage | undefined)
}
...
export const StorageNode: sts.Type<StorageNode> = sts.struct(() => {
    return  {
        ...
        props: StorageNodeProps,
        totalUsage: sts.option(() => NodeUsage),
    }
})
...
export interface Bucket {
    ...
    isPublic: boolean
    isRemoved: boolean
    totalCustomersUsage?: (BucketUsage | undefined)
}
...
export const Bucket: sts.Type<Bucket> = sts.struct(() => {
    return  {
        ...
        totalCustomersUsage: sts.option(() => BucketUsage),
    }
})

export const BucketUsage: sts.Type<BucketUsage> = sts.struct(() => {
    return  {
        transferredBytes: sts.bigint(),
        storedBytes: sts.bigint(),
        numberOfPuts: sts.bigint(),
...
export interface DdcVerificationEvent_EraValidationRootsPosted {
    ...
    payersBatchMerkleRootHashes: Bytes[]
    payeesBatchMerkleRootHashes: Bytes[]
}
