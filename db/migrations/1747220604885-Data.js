module.exports = class Data1747220604885 {
    name = 'Data1747220604885'

    async up(db) {
        await db.query(`CREATE TABLE "ddc_node" ("id" character varying NOT NULL, "created_at_block_height" integer NOT NULL, "host" text NOT NULL, "domain" text, "ssl" boolean NOT NULL, "http_port" integer NOT NULL, "grpc_port" integer NOT NULL, "p2p_port" integer NOT NULL, "mode" character varying(7) NOT NULL, "transferred_bytes" numeric NOT NULL, "stored_bytes" numeric NOT NULL, "number_of_puts" numeric NOT NULL, "number_of_gets" numeric NOT NULL, "provider_id_id" character varying, "cluster_id_id" character varying, CONSTRAINT "PK_cb26b78b5ac027ee4e2e8cda6d9" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "ddc_bucket" ("id" character varying NOT NULL, "created_at_block_height" integer NOT NULL, "is_public" boolean NOT NULL, "is_removed" boolean NOT NULL, "transferred_bytes" numeric NOT NULL, "stored_bytes" numeric NOT NULL, "number_of_puts" numeric NOT NULL, "number_of_gets" numeric NOT NULL, "owner_id_id" character varying, "cluster_id_id" character varying, CONSTRAINT "PK_6d33780d47ec0e7960c90e5b69f" PRIMARY KEY ("id"))`)
