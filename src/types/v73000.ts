 ...
 */
export type TokenGatewayEvent = TokenGatewayEvent_AssetReceived | TokenGatewayEvent_AssetRefunded | TokenGatewayEvent_AssetTeleported | TokenGatewayEvent_ERC6160AssetRegistrationDispatched
 ...
 * Pallet Events
 */
export type IsmpEvent = IsmpEvent_ConsensusClientCreated | IsmpEvent_ConsensusClientFrozen | IsmpEvent_Errors | IsmpEvent_GetRequestHandled | IsmpEvent_GetRequestTimeoutHandled | IsmpEvent_PostRequestHandled | IsmpEvent_PostRequestTimeoutHandled | IsmpEvent_PostResponseHandled | IsmpEvent_PostResponseTimeoutHandled | IsmpEvent_Request | IsmpEvent_Response | IsmpEvent_StateCommitmentVetoed | IsmpEvent_StateMachineUpdated
 ...
 * The `Event` enum of this pallet
 */
export type HyperbridgeEvent = HyperbridgeEvent_HostParamsUpdated | HyperbridgeEvent_ProtocolRevenueWithdrawn | HyperbridgeEvent_RelayerFeeWithdrawn
 ...
 */
export type DdcVerificationEvent = DdcVerificationEvent_BatchIndexOverflow | DdcVerificationEvent_BatchIndexUnderflow | DdcVerificationEvent_BeginChargingCustomersTransactionError | DdcVerificationEvent_BeginPayoutTransactionError | DdcVerificationEvent_BeginRewardingProvidersTransactionError | DdcVerificationEvent_BucketsInspectionError | DdcVerificationEvent_ChallengeResponseError | DdcVerificationEvent_CommitPayoutFingerprintTransactionError | DdcVerificationEvent_EndChargingCustomersTransactionError | DdcVerificationEvent_EndPayoutTransactionError | DdcVerificationEvent_EndRewardingProvidersTransactionError | DdcVerificationEvent_FailedToCalculatePayeesBatches | DdcVerificationEvent_FailedToCalculatePayersBatches | DdcVerificationEvent_FailedToCollectVerificationKey | DdcVerificationEvent_FailedToCreateMerkleProof | DdcVerificationEvent_FailedToCreateMerkleRoot | DdcVerificationEvent_FailedToFetchBucketChallenge | DdcVerificationEvent_FailedToFetchCollectors | DdcVerificationEvent_FailedToFetchCustomerId | DdcVerificationEvent_FailedToFetchGCollectors | DdcVerificationEvent_FailedToFetchInspectionReceipt | DdcVerificationEvent_FailedToFetchNodeChallenge | DdcVerificationEvent_FailedToFetchPaymentEra | DdcVerificationEvent_FailedToFetchProtocolParams | DdcVerificationEvent_FailedToFetchProviderId | DdcVerificationEvent_FailedToFetchTraversedEHD | DdcVerificationEvent_FailedToFetchTraversedPHD | DdcVerificationEvent_FailedToFetchVerificationKey | DdcVerificationEvent_FailedToFetchVerifiedDeltaUsage | DdcVerificationEvent_FailedToFetchVerifiedPayableUsage | DdcVerificationEvent_FailedToParseBucketId | DdcVerificationEvent_FailedToParseCustomerId | DdcVerificationEvent_FailedToParseEHDId | DdcVerificationEvent_FailedToParseNodeKey | DdcVerificationEvent_FailedToParsePHDId | DdcVerificationEvent_FailedToSaveInspectionReceipt | DdcVerificationEvent_FailedToSignInspectionReceipt | DdcVerificationEvent_NodesInspectionError | DdcVerificationEvent_PaidEraRetrievalError | DdcVerificationEvent_PayoutReceiptDoesNotExist | DdcVerificationEvent_SendChargingCustomersBatchTransactionError | DdcVerificationEvent_SendRewardingProvidersBatchTransactionError | DdcVerificationEvent_TimeCapsuleError | DdcVerificationEvent_TraverseResponseError | DdcVerificationEvent_ValidatorKeySet

export interface DdcVerificationEvent_BatchIndexOverflow {
    __kind: 'BatchIndexOverflow'
    clusterId: H160
    eraId: number
    validator: AccountId32
}

export interface DdcVerificationEvent_BatchIndexUnderflow {
    __kind: 'BatchIndexUnderflow'
    clusterId: H160
    eraId: number
    validator: AccountId32
}
...
export interface DdcVerificationEvent_BucketsInspectionError {
    __kind: 'BucketsInspectionError'
}

export interface DdcVerificationEvent_ChallengeResponseError {
    __kind: 'ChallengeResponseError'
    clusterId: H160
    eraId: number
...
export interface DdcVerificationEvent_FailedToCalculatePayeesBatches {
    __kind: 'FailedToCalculatePayeesBatches'
    eraId: number
}

export interface DdcVerificationEvent_FailedToCalculatePayersBatches {
    __kind: 'FailedToCalculatePayersBatches'
    eraId: number
}
...
export interface DdcVerificationEvent_FailedToFetchBucketChallenge {
    __kind: 'FailedToFetchBucketChallenge'
}

export interface DdcVerificationEvent_FailedToFetchCollectors {
    __kind: 'FailedToFetchCollectors'
    clusterId: H160
    validator: AccountId32
}

export interface DdcVerificationEvent_FailedToFetchCustomerId {
    __kind: 'FailedToFetchCustomerId'
    bucketId: bigint
}

export interface DdcVerificationEvent_FailedToFetchGCollectors {
    __kind: 'FailedToFetchGCollectors'
    clusterId: H160
    validator: AccountId32
}
...
export interface DdcVerificationEvent_FailedToFetchProtocolParams {
    __kind: 'FailedToFetchProtocolParams'
    clusterId: H160
}

export interface DdcVerificationEvent_FailedToFetchProviderId {
    __kind: 'FailedToFetchProviderId'
    nodeKey: NodePubKey
}
...
export interface DdcVerificationEvent_FailedToParseBucketId {
    __kind: 'FailedToParseBucketId'
    bucketId: string
}

export interface DdcVerificationEvent_FailedToParseCustomerId {
    __kind: 'FailedToParseCustomerId'
    customerId: AccountId32
}

export interface DdcVerificationEvent_FailedToParseEHDId {
    __kind: 'FailedToParseEHDId'
    ehdId: string
}

export interface DdcVerificationEvent_FailedToParseNodeKey {
    __kind: 'FailedToParseNodeKey'
    nodeKey: string
}

export interface DdcVerificationEvent_FailedToParsePHDId {
    __kind: 'FailedToParsePHDId'
    phdId: string
}
...
export interface DdcVerificationEvent_FailedToSignInspectionReceipt {
    __kind: 'FailedToSignInspectionReceipt'
}

export interface DdcVerificationEvent_NodesInspectionError {
    __kind: 'NodesInspectionError'
}

export interface DdcVerificationEvent_PaidEraRetrievalError {
    __kind: 'PaidEraRetrievalError'
    clusterId: H160
    validator: AccountId32
}
...
export interface DdcVerificationEvent_TimeCapsuleError {
    __kind: 'TimeCapsuleError'
}

export interface DdcVerificationEvent_TraverseResponseError {
    __kind: 'TraverseResponseError'
    clusterId: H160
    eraId: number
    aggregateKey: AggregateKey
    aggregator: NodePubKey
...
export type Type_419 = Type_419_ApplyExtrinsic | Type_419_Finalization | Type_419_Initialization

export interface Type_419_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_419_Finalization {
    __kind: 'Finalization'
}

export interface Type_419_Initialization {
...
export const DdcVerificationEvent: sts.Type<DdcVerificationEvent> = sts.closedEnum(() => {
    return  {
        BatchIndexOverflow: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        BatchIndexUnderflow: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            validator: AccountId32,
        }),
        ...
        BucketsInspectionError: sts.unit(),
        ChallengeResponseError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            aggregateKey: AggregateKey,
            aggregator: NodePubKey,
        ...
        FailedToCalculatePayeesBatches: sts.enumStruct({
            eraId: sts.number(),
        }),
        FailedToCalculatePayersBatches: sts.enumStruct({
            eraId: sts.number(),
        }),
        ...
        FailedToFetchBucketChallenge: sts.unit(),
        FailedToFetchCollectors: sts.enumStruct({
            clusterId: H160,
            validator: AccountId32,
        }),
        FailedToFetchCustomerId: sts.enumStruct({
            bucketId: sts.bigint(),
        }),
        FailedToFetchGCollectors: sts.enumStruct({
            clusterId: H160,
            validator: AccountId32,
        }),
        ...
        FailedToFetchProtocolParams: sts.enumStruct({
            clusterId: H160,
        }),
        FailedToFetchProviderId: sts.enumStruct({
            nodeKey: NodePubKey,
        }),
        ...
        FailedToParseBucketId: sts.enumStruct({
            bucketId: sts.string(),
        }),
        FailedToParseCustomerId: sts.enumStruct({
            customerId: AccountId32,
        }),
        FailedToParseEHDId: sts.enumStruct({
            ehdId: sts.string(),
        }),
        FailedToParseNodeKey: sts.enumStruct({
            nodeKey: sts.string(),
        }),
        FailedToParsePHDId: sts.enumStruct({
            phdId: sts.string(),
        }),
        FailedToSaveInspectionReceipt: sts.unit(),
        FailedToSignInspectionReceipt: sts.unit(),
        NodesInspectionError: sts.unit(),
        PaidEraRetrievalError: sts.enumStruct({
            clusterId: H160,
            validator: AccountId32,
        }),
        ...
        TimeCapsuleError: sts.unit(),
        TraverseResponseError: sts.enumStruct({
            clusterId: H160,
            eraId: sts.number(),
            aggregateKey: AggregateKey,
            aggregator: NodePubKey,
