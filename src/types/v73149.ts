 ...
 * The `Event` enum of this pallet
 */
export type FeeHandlerEvent = FeeHandlerEvent_FeeDistributionProportionConfigSet | FeeHandlerEvent_ManualFeeAccountTopUp | FeeHandlerEvent_NativeTokenBurned

/**
 * Fee distribution configuration updated.
 */
export interface FeeHandlerEvent_FeeDistributionProportionConfigSet {
    __kind: 'FeeDistributionProportionConfigSet'
...
export interface FeeDistributionProportion {
    treasuryProportion: Permill
    feePotProportion: Permill
}
...
export type Type_434 = Type_434_ApplyExtrinsic | Type_434_Finalization | Type_434_Initialization

export interface Type_434_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_434_Finalization {
    __kind: 'Finalization'
}

export interface Type_434_Initialization {
...
export const FeeHandlerEvent: sts.Type<FeeHandlerEvent> = sts.closedEnum(() => {
    return  {
        FeeDistributionProportionConfigSet: sts.enumStruct({
            config: FeeDistributionProportion,
        }),
...
export const FeeDistributionProportion: sts.Type<FeeDistributionProportion> = sts.struct(() => {
    return  {
        treasuryProportion: Permill,
        feePotProportion: Permill,
    }
