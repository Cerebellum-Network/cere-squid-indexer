...
export type Type_328 = Type_328_ApplyExtrinsic | Type_328_Finalization | Type_328_Initialization

export interface Type_328_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_328_Finalization {
    __kind: 'Finalization'
}

export interface Type_328_Initialization {
